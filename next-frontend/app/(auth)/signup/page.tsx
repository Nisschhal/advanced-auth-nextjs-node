...
export default function SignUp() {
  ...
  return (
    <>
      <main className="container mx-auto w-full md:w-2xl lg:w-3xl min-h-[590px] h-auto  pt-10">
        {!isSubmitted ? (
          <div className="w-full p-5 rounded-md">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <Button
                  className="w-full text-[15px] h-[40px] !bg-primary-500 text-white font-semibold"
                  disabled={isPending}
                  type="submit"
                >
